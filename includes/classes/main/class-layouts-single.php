...
if( !class_exists( 'PIP_Layouts_Single' ) ) {
    ...
    class PIP_Layouts_Single {
         ...
         * Validate New Layout
         */
        function validate_new( $field_group ) {
         ...
         */
        function validate_single( $field_group ) {
        ...
        public function metaboxes() {
            ...
            add_meta_box(
                ...
                'acf-field-group',
                'side',
                'default', array( 'field_group' => $field_group )
            );
        ...
        function get_layouts_with_same_slug( $slug, $field_group ) {
