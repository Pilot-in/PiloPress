...
if ( !class_exists( 'PIP_Admin' ) ) {
    class PIP_Admin {
        public function __construct() {
            ...
            add_action( 'acf/render_field/type=color_picker', array( $this, 'hide_free_color_picker' ), 15 );
        }
        ...
        public function add_setting_color_picker( $field ) {
            acf_render_field_setting( $field, array(
                'label'         => __( 'Hide custom color picker' ),
                'instructions'  => __( '' ),
                'name'          => 'hide_free_color_picker',
                'type'          => 'true_false',
                'ui'            => '1',
                'default_value' => '0',
            ) );
         ...
         * @param $field
         */
        public function hide_free_color_picker( $field ) {
            if ( !isset( $field['hide_free_color_picker'] ) ) {
                return;
            }
            ...
            $hide_free_color_picker = $field['hide_free_color_picker'] ? $field['hide_free_color_picker'] : false;
            if ( $hide_free_color_picker !== 1 ) {
                return;
            }
